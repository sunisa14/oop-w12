...
namespace oop_w15
{
    public partial class Form1 : Form
    {
        ...
        private void txtPubPhone_TextChanged(object sender, EventArgs e)
        {

        }

        private void txtPubAddress_TextChanged(object sender, EventArgs e)
        {

        }

        private void txtPubName_TextChanged(object sender, EventArgs e)
        {
